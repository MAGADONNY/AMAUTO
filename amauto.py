...
st.markdown('<p style="text-align: left; padding-left: 380px; font-size: 22px; font-weight: normal; color: #111111; font-family: sans-serif; margin-bottom: 20px; letter-spacing: 1px;">KONTAKT INFORMACIJE</p>', unsafe_allow_html=True)
